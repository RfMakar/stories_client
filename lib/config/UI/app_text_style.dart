...
final class AppTextStyles {
  static TextStyle s12h000000n = TextStyle(
    color: AppColors.hex000000,
    fontSize: 12,
    fontWeight: FontWeight.normal,
  );
  static TextStyle s12hE7E7E7n = TextStyle(
  ...
  static TextStyle s12h5F3430n = TextStyle(
  ...
  static TextStyle s14h000000n = TextStyle(
   ...
   static TextStyle s14h000000b = TextStyle(
    color: AppColors.hex000000,
    fontSize: 14,
  ...
  static TextStyle s14h5F3430n = TextStyle(
    color: AppColors.hex5F3430,
    fontSize: 14,
    fontWeight: FontWeight.normal,
  );
  static TextStyle s16hFFFFFFn = TextStyle(
    color: AppColors.hexFFFFFF,
    fontSize: 16,
    fontWeight: FontWeight.normal,
  );
   static TextStyle s16h79553Dn = TextStyle(
    color: AppColors.hex79553D,
    fontSize: 16,
    fontWeight: FontWeight.normal,
  );
  static TextStyle s16h000000n = TextStyle(
    color: AppColors.hex000000,
    fontSize: 16,
    fontWeight: FontWeight.normal,
  );
  ...
  static TextStyle s20h79553Dn = TextStyle(
    color: AppColors.hex79553D,
    fontSize: 20,
    fontWeight: FontWeight.normal,
  );
